...
import com.peixian.system.util.FastDFSClient;
import com.peixian.system.util.FastDFSFile;
...
public class FileController {
    ...
    public ResponseEntity<byte[]> download(){
        ...
        try {
            headers.setContentDispositionFormData("attachment", new String("123.jpg".getBytes("UTF-8"),"iso8859-1"));
